...
"[project]/src/app/caterer/dashboard/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DashboardPage() {
    ...
    const { totalRevenue, totalOrders, salesData, popularItemsData, recentOrders, mostPopularItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!orders) {
            return {
                totalRevenue: 0,
                totalOrders: 0,
        ...
        const last7Days = Array.from({
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(d, 'yyyy-MM-dd');
        }).reverse();
        const dailySales = last7Days.map((dateStr)=>{
            const dayRevenue = validOrders.filter((order)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(order.orderDate.seconds * 1000), 'yyyy-MM-dd') === dateStr).reduce((sum, order)=>sum + order.totalAmount + (order.packagingFee || 0), 0);
            return {
                name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(dateStr), 'EEE'),
                revenue: dayRevenue
            };
        });
        // Popular items
        ...
        const top4Items = sortedItems.slice(0, 4).map(([name, count])=>({
                name,
                orders: count
            }));
        ...
        const sortedOrders = [
            ...orders
        ].sort((a, b)=>b.orderDate.seconds - a.orderDate.seconds).slice(0, 5);
        const recent = sortedOrders.map((order)=>({
                ...order,
                date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(order.orderDate.seconds * 1000), 'yyyy-MM-dd')
            }));
        return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e56b21a7._.js.map